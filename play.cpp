...
void play_::checkmap()
{
    ...
    if (x1 >= 0 && x2 < MAX_MAP_X && y1 >= 0 && y2 < MAX_MAP_Y)
    {
        if (x_val_ > 0)
        {
            if (mat[y1][x2] == 1 || mat[y2][x2] == 1 || mat[y1][x2] == 6 || mat[y2][x2] == 6 || ((mat[y1][x2] == 2 || mat[y2][x2] == 2) && ok[2] == 0))
            {
                x_pos_ = x2 * TILE_SIZE;
                x_pos_ -= rect_.w;
                x_val_ = 0;
        ...
        {
            if (mat[y1][x1] == 1 || mat[y2][x1] == 1 || mat[y1][x1] == 6 || mat[y2][x1] == 6 || ((mat[y1][x1] == 2 || mat[y2][x1] == 2) && ok[2] == 0))
            {
    ...
    if (x1 >= 0 && x2 < MAX_MAP_X && y1 >= 0 && y2 < MAX_MAP_Y)
    {
        if (y_val_ > 0)
        {
            if (mat[y2][x1] == 1 || mat[y2][x2] == 1 || mat[y2][x1] == 6 || mat[y2][x2] == 6 || ((mat[y2][x1] == 2 || mat[y2][x2] == 2) && ok[2] == 0))
            {
                y_pos_ = y2 * TILE_SIZE;
                y_pos_ -= rect_.h;
                y_val_ = 0;
        ...
        {
            if (mat[y1][x1] == 1 || mat[y1][x2] == 1 || mat[y1][x1] == 6 || mat[y1][x2] == 6 || ((mat[y1][x1] == 2 || mat[y1][x2] == 2) && ok[2] == 0))
            {
